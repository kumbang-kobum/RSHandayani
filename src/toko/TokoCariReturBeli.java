    ...
    public TokoCariReturBeli(java.awt.Frame parent, boolean modal) {
        ...
        suplier.addWindowListener(new WindowListener() {
            ...
            public void windowClosed(WindowEvent e) {
                if(akses.getform().equals("TokoCariReturBeli")){
...
*/
    ...
    private void btnSuplierActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSuplierActionPerformed
        akses.setform("TokoCariReturBeli");
        suplier.emptTeks();
        suplier.isCek();
          ...
          try {
             ...
             try {
                ...
                if(rs.next()){
                    ...
                    sukses=jur.simpanJurnal(rs.getString("no_retur_beli"),"U","K146 BATAL TRANSAKSI RETUR BELI TOKO"+", OLEH "+akses.getkode());
