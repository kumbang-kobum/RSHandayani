                    ...
                    try{
                        ...
                        if(sukses==true){
                            if(status.equals("Ranap")){
                                ...
                                sukses=jur.simpanJurnal(tbDokter.getValueAt(tbDokter.getSelectedRow(),0).toString(),"U","K103 PEMBATALAN PEMERIKSAAN RADIOLOGI RAWAT INAP PASIEN "+tbDokter.getValueAt(tbDokter.getSelectedRow(),1).toString()+" OLEH "+akses.getkode());  //tambah chan
                                ...
                                sukses=jur.simpanJurnal(tbDokter.getValueAt(tbDokter.getSelectedRow(),0).toString(),"U","K104 PEMBATALAN PEMERIKSAAN RADIOLOGI RAWAT JALAN PASIEN "+tbDokter.getValueAt(tbDokter.getSelectedRow(),1).toString()+" OLEH "+akses.getkode());  //tambah chan
                            }
                        }
                ...
                if((!Kd2.getText().equals(""))&&(!Petugas.getText().equals(""))){
                     try {
                        ...
                        try {
                            ...
                            while(rs.next()){
                                htmlContent.append("<tr><td border='0' align='center'><a href="+rs.getString("lokasi_gambar")+"'><img src='http://"+koneksiDB.HOSTHYBRIDWEB()+":"+koneksiDB.PORTWEB()+"/"+koneksiDB.HYBRIDWEB()+"/radiologi/"+rs.getString("lokasi_gambar")+"' alt='photo' width='"+(internalFrame1.getWidth()-370)+"' height='"+(internalFrame1.getWidth()-370)+"'/></a></td></tr>"); //tambah chan
                            }
                            LoadHTML.setText(
                                "<html>"+
