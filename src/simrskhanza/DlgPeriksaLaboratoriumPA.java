        ...
        try {                    
            ...
            if(sukses==true){
                ...
                if(status.equals("Ranap")){
                    ...
                    sukses=jur.simpanJurnal(TNoRw.getText(),"U","K115 PEMERIKSAAN LABORAT RAWAT INAP PASIEN "+TPasien.getText()+" DIPOSTING OLEH "+akses.getkode());  //tambah chan
                }else if(status.equals("Ralan")){
                    Sequel.queryu("delete from tampjurnal");    
                    if(ttlpendapatan>0){
                    ...
                    sukses=jur.simpanJurnal(TNoRw.getText(),"U","K116 PEMERIKSAAN LABORAT RAWAT JALAN PASIEN "+TPasien.getText()+" DIPOSTING OLEH "+akses.getkode()); //tambah chan
                }
            }
