                  ...
                  try {
                     ...
                     if(rs.next()){
                         ...
                         if(sukses==true){
                            ...
                            sukses=jur.simpanJurnal(rs.getString("no_faktur"),"U","K014 BATAL TRANSAKSI PENERIMAAN BARANG DI "+Sequel.cariIsi("select bangsal.nm_bangsal from bangsal where bangsal.kd_bangsal=?",rs.getString("kd_bangsal")).toUpperCase()+", OLEH "+akses.getkode()); //tambah chan
                         }
