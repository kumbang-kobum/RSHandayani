...
public class DlgCariPenjualan extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        AkunBayar.setBounds(84, 32, 300, 23);
                        ...
                        if(rs.getString("status").equals("Sudah Dibayar")){
                            if(akses.getkode().equals("Admin Utama")){
                                ...
                                if(sukses==true){
                                    ...
                                    sukses=jur.simpanJurnal(rs.getString("nota_jual"),"U","K017 BATAL PENJUALAN DI "+Sequel.cariIsi("select bangsal.nm_bangsal from bangsal where bangsal.kd_bangsal='"+rs.getString("kd_bangsal")+"'").toUpperCase()+", OLEH "+akses.getkode());
                                }
                  ...
                  if(rs.next()){
                      if(rs.getString("status").equals("Sudah Dibayar")){
                         ...
                         if(sukses==true){
                            ...
                            sukses=jur.simpanJurnal(rs.getString("nota_jual"),"U","K018 PENJUALAN DI "+Sequel.cariIsi("select bangsal.nm_bangsal from bangsal where bangsal.kd_bangsal='"+rs.getString("kd_bangsal")+"'").toUpperCase()+", OLEH "+akses.getkode()); 
                         }
