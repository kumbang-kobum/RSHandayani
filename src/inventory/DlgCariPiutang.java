              ...
              try {
                 ...
                 if(rs.next()){
                     ...
                     if(sukses==true){
                         ...
                         sukses=jur.simpanJurnal(rs.getString("nota_piutang"),"U","K019 BATAL PIUTANG OBAT DI "+Sequel.cariIsi("select bangsal.nm_bangsal from bangsal where bangsal.kd_bangsal='"+rs.getString("kd_bangsal")+"'").toUpperCase()+", OLEH "+akses.getkode());
                     }
