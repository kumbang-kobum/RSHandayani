...
public class DlgCariReturJual extends javax.swing.JDialog {
    ...
    public DlgCariReturJual(java.awt.Frame parent, boolean modal) {
        ...
        petugas.addWindowListener(new WindowListener() {
            ...
            public void windowClosed(WindowEvent e) {
                if(akses.getform().equals("DlgCariReturJual")){
    ...
    private void btnPetugasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPetugasActionPerformed
        akses.setform("DlgCariReturJual");
            ...
            if(rs.next()){        
                ...
                if(!(rs.getString(1).length()>16)){
                    if(sukses==true){
                        ...
                        sukses=jur.simpanJurnal(rs.getString("no_retur_jual"),"U","K021 BATAL RETUR PENJUALAN DI "+Sequel.cariIsi("select bangsal.nm_bangsal from bangsal where bangsal.kd_bangsal='"+rs.getString("kd_bangsal")+"'").toUpperCase()+", OLEH "+akses.getkode());
                    }
                }
