            ...
            if(Sequel.cariRegistrasi(NoRawat.getText())>0){
                ...
                if(sukses==true){
                    ...
                    if(ttlpendapatan>0){
                        ...
                        Sequel.menyimpan("tampjurnal","'"+Tindakan_Ralan+"','Pendapatan Tindakan Rawat Jalan','0','"+ttlpendapatan+"'","kredit=kredit+'"+(ttlpendapatan)+"'","kd_rek='"+Tindakan_Ralan+"'");                             
                    }
                    if(ttljmdokter>0){
                    ...
                    sukses=jur.simpanJurnal(NoRawat.getText(),"U","K159 TINDAKAN RAWAT JALAN PASIEN "+NoRawat.getText()+" DIPOSTING OLEH "+akses.getkode());    //tambah chan
                }
                ...
                if(sukses==true){
                    ...
                    sukses=jur.simpanJurnal(NoRawat.getText(),"U","K160 PEMBERIAN OBAT RAWAT JALAN PASIEN, DIPOSTING OLEH "+akses.getkode());    //tambah chan 
                }
