                ...
                try {
                    ...
                    try {
                        ...
                        if(rs.next()){
                            ...
                            sukses=jur.simpanJurnal(Nomor.getText(),"U","K070 PEMASUKAN LAIN-LAIN OLEH "+", Keperluan "+Keperluan.getText()+", OLEH "+akses.getkode());//tambah chan
                        }
                    } catch (Exception e) {
                        sukses=false;
                    ...
                    try {
                        ...
                        try{
                            ...
                            if(rs.next()){
                                ...
                                sukses=jur.simpanJurnal(tbResep.getValueAt(tbResep.getSelectedRow(),0).toString(),"U","K071 PEMBATALAN PEMASUKAN LAIN-LAIN "+", Keperluan "+Keperluan.getText()+", OLEH "+akses.getkode());//tambah chan
                            } 
                        } catch (Exception e) {
                            sukses=false;
                            System.out.println("Jurnal : "+e);
