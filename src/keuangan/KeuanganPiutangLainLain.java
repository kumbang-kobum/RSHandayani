    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
       if(NoNota.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf("piutang_lainlain","?,?,?,?,?,?,?,?,?,?,'Belum Lunas'","No.Nota",10,new String[]{
                    ...
                    sukses=jur.simpanJurnal(NoNota.getText(),"U","K090 PIUTANG PERUSAHAAN/LAIN-LAIN"+", OLEH "+akses.getkode());    //tambah chan               
            }else{
                sukses=false;
            }  
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if(tbKamar.getSelectedRow()>-1){
            ...
            if(Sequel.queryu2tf("delete from piutang_lainlain where nota_piutang=?", 1,new String[]{
                ...
                sukses=jur.simpanJurnal(NoNota.getText(),"U","K091 PEMBATALAN PIUTANG LAIN-LAIN"+", OLEH "+akses.getkode());    //tambah chan 
            }else{
                sukses=false;
            }
