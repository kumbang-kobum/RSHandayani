            ...
            try {          
                if(pilihtable.equals("rawat_inap_dr")||pilihtable.equals("rawat_inap_pr")||pilihtable.equals("rawat_inap_drpr")){
                    ...
                    if(sukses==true){
                        ...
                        sukses=jur.simpanJurnal(TNoRw.getText(),"U","K066 PEMBATALAN TINDAKAN RAWAT INAP PASIEN OLEH "+akses.getkode());  //tambah chan
                    }
                    ...
                    if(sukses==true){
                        ...
                        sukses=jur.simpanJurnal(TNoRw.getText(),"U","K067 TINDAKAN RAWAT INAP PASIEN "+TPasien.getText()+" DIPOSTING OLEH "+akses.getkode());   //tambah chan
                    }
