                ...
                if(tabMode.getValueAt(i,0).toString().equals("true")&&(Valid.SetAngka(tabMode.getValueAt(i,10).toString())>0)){
                    if(Sequel.menyimpantf("bayar_piutang","?,?,?,?,?,?,?,?,?,?,?","Data",11,new String[]{
                        ...
                        if(Valid.SetAngka(tabMode.getValueAt(i,11).toString())>=100){
                            ...
                            sukses=jur.simpanJurnal(tabMode.getValueAt(i,1).toString(),"U","K093 BAYAR PIUTANG BPJS"+", OLEH "+kdptg.getText());  //tambah chan
                            ...
                            sukses=jur.simpanJurnal(tabMode.getValueAt(i,1).toString(),"U","K094 RVP PIUTANG PASIEN BPJS, OLEH "+kdptg.getText());     //tambah chan
                            ...
                            if(sukses==true){
                                ...
                                sukses=jur.simpanJurnal(tabMode.getValueAt(i,1).toString(),"U","K095 RVP PIUTANG PASIEN BPJS, OLEH "+kdptg.getText());   //tambah chan  
                                if(sukses==true){
                                    //jurnal kerugian 
                                    Sequel.queryu("delete from tampjurnal");
                                    ...
                                    Sequel.menyimpan("tampjurnal","'"+koderekening+"','"+AkunBayar.getSelectedItem()+"','"+tabMode.getValueAt(i,10).toString()+"','0'","debet=debet+'"+tabMode.getValueAt(i,10).toString()+"'","kd_rek='"+koderekening+"'"); 
                                    sukses=jur.simpanJurnal(tabMode.getValueAt(i,1).toString(),"U","K096 RVP PIUTANG BPJS"+", OLEH "+kdptg.getText()); //tambah chan
