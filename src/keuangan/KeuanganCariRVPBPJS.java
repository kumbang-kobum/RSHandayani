            ...
            for(i=0;i<row;i++){  
                if(tabMode.getValueAt(i,0).toString().equals("true")){
                    ...
                    if(Valid.SetAngka(tabMode.getValueAt(i,11).toString())>=100){
                        ...
                        sukses=jur.simpanJurnal(tabMode.getValueAt(i,1).toString(),"U","K085 PEMBATALAN RVP PIUTANG BPJS"+", OLEH "+akses.getkode());      //tambah chan
                        ...
                        sukses=jur.simpanJurnal(tabMode.getValueAt(i,1).toString(),"U","K086 PEMBATALAN RVP PIUTANG BPJS, OLEH "+akses.getkode());     //tambah chan
                        ...
                        if(sukses==true){
                            ...
                            sukses=jur.simpanJurnal(tabMode.getValueAt(i,1).toString(),"U","K087 PEMBATALAN RVP PIUTANG BPJS, OLEH "+akses.getkode());     //tambah chan
                            ...
                            if(sukses==true){
                                ...
                                Sequel.menyimpan("tampjurnal","'"+tabMode.getValueAt(i,82).toString()+"','Akun Bayar','0','"+tabMode.getValueAt(i,10).toString()+"'","kredit=kredit+'"+tabMode.getValueAt(i,82).toString()+"'","kd_rek='"+koderekening+"'"); 
                                sukses=jur.simpanJurnal(tabMode.getValueAt(i,1).toString(),"U","K088 PEMBATALAN RVP PIUTANG BPJS"+", OLEH "+akses.getkode());    //tambah chan  
