        ...
        if(no_faktur.getText().trim().equals("")){
            ...
            try {   
                if(sisahutang>0){
                    ...
                    sukses=jur.simpanJurnal(no_bukti.getText(),"U","K080 BAYAR PELUNASAN BARANG NON MEDIS NO.FAKTUR "+no_faktur.getText()+", OLEH "+akses.getkode());//tambah chan
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        try {
            ...
            if(Sequel.queryu2tf("delete from toko_bayar_pemesanan where tgl_bayar=? and no_faktur=? and "+
                ...
                sukses=jur.simpanJurnal(no_bukti.getText(),"U","K081 BATAL BAYAR PELUNASAN BARANG NON MEDIS NO.FAKTUR "+no_faktur.getText()+", OLEH "+akses.getkode());    //tambah chan
            }else{
                sukses=false;
            }
