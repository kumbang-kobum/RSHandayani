...
public final class KeuanganPiutangBelumLunas extends javax.swing.JDialog {
    ...
    private String status="",Diskon_Piutang="",Piutang_Tidak_Terbayar="";
    ...
    private void initComponents() {
        ...
        AkunBayar.setPreferredSize(new java.awt.Dimension(390, 23));
                ...
                if(tabMode.getValueAt(i,0).toString().equals("true")){
                    if(Double.parseDouble(tabMode.getValueAt(i,8).toString())<0){
                        ...
                        if(Sequel.menyimpantf("bayar_piutang","?,?,?,?,?,?,?,?,?,?,?","Data",11,new String[]{
                            ...
                            sukses=jur.simpanJurnal(tabMode.getValueAt(i,1).toString(),"U","K089 BAYAR PIUTANG"+", OLEH "+akses.getkode());     //tambah chan              
                        }else{
                            sukses=false;
                        }
                    }   
