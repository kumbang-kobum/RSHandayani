    ...
    try {
        ...
        if(i>0){
            if(!tbBilling.getValueAt(0,1).toString().trim().contains("No.Nota")){
                ...
                if(sukses==true){
                    if(piutang>0){
                       sukses=jur.simpanJurnal(TNoRw.getText(),"U","K055 PEMBATALAN PIUTANG PASIEN RAWAT JALAN "+TNoRw.getText()+" "+TNoRM.getText()+" "+TPasien.getText()+", DIBATALKAN OLEH "+akses.getkode());   //tambah chan 
                    }else if(piutang<=0){
                       sukses=jur.simpanJurnal(TNoRw.getText(),"U","K056 PEMBATALAN PEMBAYARAN PASIEN RAWAT JALAN "+TNoRw.getText()+" "+TNoRM.getText()+" "+TPasien.getText()+", DIBATALKAN OLEH "+akses.getkode());    //tambah chan
                    } 
                }
            ...
            try {
                ...
                if(sukses==true){
                    ...
                    if(sukses==true){
                        ...
                        if(piutang>0){
                            sukses=jur.simpanJurnal(TNoRw.getText(),"U","K057 PIUTANG PASIEN RAWAT JALAN "+TNoRw.getText()+" "+TNoRM.getText()+" "+TPasien.getText()+", DIPOSTING OLEH "+akses.getkode()); //tambah chan
                            if(bayar>0){
                            ...
                            sukses=jur.simpanJurnal(TNoRw.getText(),"U","K058 PEMBAYARAN PASIEN RAWAT JALAN "+TNoRw.getText()+" "+TNoRM.getText()+" "+TPasien.getText()+", DIPOSTING OLEH "+akses.getkode());//tambah chan
                            if(Sequel.menyimpantf2("tagihan_sadewa","'"+TNoRw.getText()+"','"+TNoRM.getText()+"','"+TPasien.getText().replaceAll("'","")+"','"+alamat.replaceAll("'","")+"',concat('"+Valid.SetTgl(DTPTgl.getSelectedItem()+"")+
